...
void dob::enter_date()
{
 ...
 // clreol();
 // clreol();
 cin>>DOB11[T1.temp_val].year;
 while(DOB11[T1.temp_val].year>T1.current_year)  //to ensure that the year of birth
 ...
 while(DOB11[T1.temp_val].year<1000)
 {
  // clreol();
 ...
 while(DOB11[T1.temp_val].year<1900)
 {
  // clreol();
  cout<<"\a\nAre you sure (Y/N) ? ";
  cin>>birth_answer;
  ...
  if(birth_answer=='n'||birth_answer=='N')
  {
   ...
   cin>>DOB11[T1.temp_val].year;
   // clreol();
   while(DOB11[T1.temp_val].year>T1.current_year)
   {
    // clreol();
    cout<<"Invalid input for year !!! ";
    // clreol();
 ...
 cout<<"Month : ";
 // clreol();
 cin>>DOB11[T1.temp_val].month;
 while(DOB11[T1.temp_val].month<=0||DOB11[T1.temp_val].month>12)
 {
  // clreol();
  cout<<"\a\nInvalid input for month !!!"<<"\n";
 ...
 cout<<"Date  : ";
 // clreol();
 switch(DOB11[T1.temp_val].month)
 {
  case 1:
  case 3:
  case 5:
  ...
  case 10:
  case 12:{
           cin>>DOB11[T1.temp_val].date;           //for months with 31 days
           while(DOB11[T1.temp_val].date<1||DOB11[T1.temp_val].date>31)
           {
            // clreol();
            cout<<"\aInvalid date !!!"<<"\n";
            cout<<"Again enter the date : ";
            // clreol();
            cin>>DOB11[T1.temp_val].date;
            cout<<"\n";
           }
           break;
          }
  case 2:{                                  //for february
          cin>>DOB11[T1.temp_val].date;
          if(DOB11[T1.temp_val].year%4==0)
          {
           while(DOB11[T1.temp_val].date<0||DOB11[T1.temp_val].date>29)  //for leap year
           {
            // clreol();
            cout<<"\aInvalid date !!!"<<"\n";
            cout<<"Again enter the date : ";
          ...
          {
           while(DOB11[T1.temp_val].date<0||DOB11[T1.temp_val].date>28)  //for non-leap year
           {
            // clreol();
            cout<<"\aInvalid date !!!"<<"\n";
            cout<<"Again enter the date : ";
 ...
 default:{
          cin>>DOB11[T1.temp_val].date;            //for other months
          while(DOB11[T1.temp_val].date<1||DOB11[T1.temp_val].date>30)
          {
           // clreol();
           cout<<"\aInvalid date !!!"<<"\n";
           cout<<"Again enter the date : ";
...
void all::exit_function()
{
 ...
 cout<<"\n\n\n\t\t\t ***SOFTWARE DETAILS***\n";
 cout<<"\n\n\tDeveloper                : uday rastogi "<<"\n";
 cout<<"\tProgramming Language     : C++ "<<"\n";
 cout<<"\tCompiler version         : Borland 5.02 "<<"\n";
 cout<<"\tAim                      : Simulation of Hospital Management Software"<<"\n";
 cout<<"\n\tHope you like it..."<<"\n";
 cout<<"\n\n\tSend your comments to    : udayrastogi2004@gmail.com "<<"\n";
 cout<<"\n\n\tThank You for trying this program. "<<"\n";
 cout<<"\n\n\n\tPress any key to continue........"<<"\n";
 getch();
 system("cls");
